...
try:
  from google3.third_party.data_agent_kit.data_agent_common.skills.partners.gcs_security_assessment.scripts import cloud_rest_helpers_nodeps
  from google3.third_party.data_agent_kit.data_agent_common.skills.partners.gcs_security_assessment.scripts import validation
except ImportError:
